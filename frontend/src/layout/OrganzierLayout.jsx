...
import { organizerLinks } from "../config/sidebarConfig"
...
const OrganizerLayout = () => {
    ...
    return (
        <div className="min-h-screen flex bg-gray-100 dark:bg-gray-950">
            ...
            <Sidebar subtitle="Organizer Panel" items={organizerLinks} isPinned={isPinned} onTogglePin={togglePin}
            ...
            <div className="flex-1 flex flex-col">
                <header className="h-14 bg-white shadow-sm dark:bg-gray-900 flex items-center justify-between px-6">
                    <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 text-left">Organizer Area</h2>

                    <div className="flex items-center gap-2">
                        <select value={theme} onChange={handleChange}
                            className="border rounded bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-700
