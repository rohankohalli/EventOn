...
import { ownerLinks } from "../config/sidebarConfig";
...
const OwnerLayout = () => {
    ...
    return (
        <div className="min-h-screen flex bg-gray-100 dark:bg-gray-950">
            ...
            <Sidebar subtitle="Owner Panel" items={ownerLinks} isPinned={isPinned} onTogglePin={togglePin}
            ...
            <div className="flex-1 flex flex-col">
                <header className="h-14 bg-white shadow-sm dark:bg-gray-900 flex items-center justify-between px-6">
                    <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 text-left">Owner Area</h2>
